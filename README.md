...
## Exercícios **05/09/2024**

1) Cadastrar 5 números num vetor e imprimir os valores cadastrados na ordem inversa. **(ex55)**

2) Criar 2 vetores com 5 elementos cada um.
Receber números num dos vetores e para cada valor digitado multiplicar por 2 e armazenar no outro vetor. **(ex57)**
